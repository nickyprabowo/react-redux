...
class ReportList extends Component {
  ...
  // Update data per page
    ...
    render() {
      ...
      var pagination = [];
      var pages = Math.ceil(this.props.totalData/this.state.limit);
      for (var i = 0; i < pages; i++) {
        pagination.push(<Menu.Item name={i+1} key={i+1} active={this.state.activeItem === i+1} onClick={this.handleItemClick} />);
      }
      ...
      return (
        ...
        <Grid>
          <Grid.Column width={10}>
            <Button as={Link} to='/home/addReport' content='Tambah' color='green' icon='plus' labelPosition='right' />
          </Grid.Column>
          <Grid.Column width={6}>
            <Form>
                <Form.Group>
